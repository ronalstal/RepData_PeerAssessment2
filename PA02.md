...
STORM_INV <- STORM[!EVTYPE %in% permitted_EVTYPES, ]
...
## [1] ggplot2_1.0.0    plyr_1.8.1       data.table_1.9.4
## 
## loaded via a namespace (and not attached):
##  [1] chron_2.3-45     codetools_0.2-9  colorspace_1.2-4 digest_0.6.4    
##  [5] evaluate_0.5.5   formatR_1.0      grid_3.1.2       gtable_0.1.2    
##  [9] htmltools_0.2.6  knitr_1.8        MASS_7.3-35      munsell_0.4.2   
## [13] proto_0.3-10     Rcpp_0.11.3      reshape2_1.4.1   rmarkdown_0.3.10
...
**on 2014-12-18 at 06:08:03 (BRT, GMT-0300)**  
